...
const Matches = () => {
  ...
  useEffect(() => {
    ...
    setMatchedProfiles(profiles.filter((p) => stored.includes(p.id)));
  }, []);
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 px-6">
        {matchedProfiles.map((profile, i) => (
          ...
          >
            ...
            <button className="absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-full bg-primary-foreground/20 backdrop-blur-sm transition-colors hover:bg-primary">
